...
public final class InterstitialAdManager_Factory implements Factory<InterstitialAdManager> {
  ...
  public InterstitialAdManager_Factory(Provider<Context> contextProvider,
      ...
      Provider<AdsPrefs> adsPrefsProvider, Provider<AdRevenueReporter> adRevenueReporterProvider) {
  ...
  public InterstitialAdManager get() {
    return newInstance(contextProvider.get(), adUnitsProvider.get(), adsConfigProvider.get(), vipGateProvider.get(), analyticsLoggerProvider.get(), adsPrefsProvider.get(), adRevenueReporterProvider.get());
  }
  ...
  public static InterstitialAdManager_Factory create(Provider<Context> contextProvider,
      ...
      Provider<VipGate> vipGateProvider, Provider<AnalyticsLogger> analyticsLoggerProvider,
      Provider<AdsPrefs> adsPrefsProvider, Provider<AdRevenueReporter> adRevenueReporterProvider) {
    return new InterstitialAdManager_Factory(contextProvider, adUnitsProvider, adsConfigProvider, vipGateProvider, analyticsLoggerProvider, adsPrefsProvider, adRevenueReporterProvider);
  }
  ...
  public static InterstitialAdManager newInstance(Context context, AdUnitsProvider adUnitsProvider,
    ...
    return new InterstitialAdManager(context, adUnitsProvider, adsConfig, vipGate, analyticsLogger, adsPrefs, adRevenueReporter);
  }
}
